...
<p>Class selectors style specific groups of elements. <br><b>Example: for a class named "bloc":</b></p>
<div class="exp">
    <code>&lt;style&gt;<br>
    .bloc { display: block;
...
<h2>ID selectors</h2>
<p>ID selectors target a specific element. <br>Example: a paragraph with id="bold":</p>
<div class="exp">
    <code>&lt;style&gt;<br>
...
<tr><td class="tbl_2_1">[href~="btn"]</td><td class="tbl_2_2">Targets elements whose href contains the word "btn" separated by space, e.g., href="secondary primary btn"</td></tr>
...
<div class="exp">
    ...
    input[type="text"]:focus { 
     <div class="cmt">/* style when typing in input type text */</div>
    border-color: cyan;
     }<br> <br>
    p:first-child { 
     <div class="cmt">/* style the first child p */</div>
    background-color: cyan;
     }<br> <br>
    p:is(.highlight, .special) { 
     <div class="cmt">/*Applies styles to all &lt;p&gt; elements that match either .highlight */</div>
    background-color: cyan;
     }<br> <br>
    &lt;/style&gt;</code>
</div>
...
<div class="exp">
    ...
    b::first-letter { 
     <div class="cmt">/* styles the first letter of element */</div>
    background-color: cyan;
     }<br> <br>
    &lt;/style&gt;</code>
</div>
...
&lt;/style&gt;</code>
<li>Some symbols can be used between selectors: (" ", "+", ">", "~")</li>
</ul>

<div class="tbl_area">
 <table class="tbl_2">
 <tr><td class="tbl_2_h">Symbol</td><td class="tbl_2_2_h">Explanation</td></tr>
<tr><td class="tbl_2_1">space</td><td class="tbl_2_2">Any nested child (child of child also included)</td></tr>
